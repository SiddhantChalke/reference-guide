    ...
    <div className='p-4'>
      ...
      {isLoading ? (
        <Loader />
          ...
          <Message variant='failure'>{error?.data.message || error.message}</Message>
        ) : (
              ...
              <tbody>
                {users.map(user =>(
                  <tr key={user._id}>
                    ...
                    {/* Delete button to delete non-admins */}
                    {/* <td className="px-4 py-2">
                      {
                        !user.isAdmin && (
                          <div className="flex">
                            <button onClick={()=> deleteHandler(user._id)} className="bg-red-100 hover:bg-red-300 text-white font-bold py-2 px-4 rounded">
                              <FaTrash />
                            </button>
                          </div>
                        )
